...
class CIFAR9(CIFAR10):
    ...
    '''
    splits = ('train', 'test', 'limited')

    def __init__(self, root, split='train',
                 transform=None, target_transform=None, download=False, resample=False, n_per_classes=500):
        ...
        self.n_per_classes = n_per_classes
    ...
    def generate_limited_dataset(self):
        ...
        for idx in indices:
            cls = self.labels[idx]
            if count_n_classes[cls] < self.n_per_classes:
                count_n_classes[cls] += 1
                selected_indices.append(idx)
            if len(selected_indices) == n_classes * self.n_per_classes:
...
if __name__ == '__main__':
    ...
    dataset = CIFAR9('/data/datasets/CIFAR9', split='limited', transform=None, resample=True)